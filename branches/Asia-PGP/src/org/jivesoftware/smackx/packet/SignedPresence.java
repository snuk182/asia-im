...
public class SignedPresence implements PacketExtension {
	...
	public SignedPresence(String keyPath, String keyPwd) {
		this.myKey = keyPath;
	...
	public void signAndSet(String stanza) throws XMPPException {
		try {
			signedStanza = sign(stanza, myKey, myKeyPwd.toCharArray());
		} catch (Exception e) {
	...
	private static String sign(String stanza, String keyPath, char[] pass) throws IOException, NoSuchAlgorithmException, NoSuchProviderException, PGPException, SignatureException {
		...
		PGPSecretKey pgpSecKey = PGPExampleUtil.readSecretKey(keyPath);
