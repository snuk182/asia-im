...
public class HistoryRecordView extends TextView {
	...
	public void setTextAndFormat(String text, String printDateMode, boolean dontDrawSmileys, boolean secure){
		...
		if (this.secure){
			setCompoundDrawablesWithIntrinsicBounds(R.drawable.lock_closed_tiny, 0, 0, 0);
		}
	}
	...
	public void messageAck(int level) {
		...
		switch(level){
		case 1:
			setCompoundDrawablesWithIntrinsicBounds((secure ? R.drawable.lock_closed_tiny : 0), 0, R.drawable.btn_check_buttonless_off, 0);
			break;
		case 2:
			setCompoundDrawablesWithIntrinsicBounds((secure ? R.drawable.lock_closed_tiny : 0), 0, R.drawable.btn_check_buttonless_on, 0);
			break;
		}		
	}
